...
dependencies = [
    ...
    "setproctitle==1.3.3",  # Gives the aba processes readable names
...
kwargs = dict(
    ...
    entry_points={
        "console_scripts": [
            "aba = chia.cmds.chia:main",
            "aba_daemon = chia.daemon.server:main",
            "aba_wallet = chia.server.start_wallet:main",
            "aba_full_node = chia.server.start_full_node:main",
            "aba_harvester = chia.server.start_harvester:main",
            "aba_farmer = chia.server.start_farmer:main",
            "aba_introducer = chia.server.start_introducer:main",
            "aba_crawler = chia.seeder.start_crawler:main",
            "aba_seeder = chia.seeder.dns_server:main",
            "aba_timelord = chia.server.start_timelord:main",
            "aba_timelord_launcher = chia.timelord.timelord_launcher:main",
            "aba_full_node_simulator = chia.simulator.start_simulator:main",
            "aba_data_layer = chia.server.start_data_layer:main",
            "aba_data_layer_http = chia.data_layer.data_layer_server:main",
            "aba_data_layer_s3_plugin = chia.data_layer.s3_plugin_service:run_server",
        ]
    },
    package_data={
...
if len(os.environ.get("ABA_SKIP_SETUP", "")) < 1:
