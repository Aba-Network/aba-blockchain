...
class MempoolManager:
    ...
    def __init__(
        ...
        *,
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 ABA per block, or about 0.00005 ABA for two
        # spends.
        self.nonzero_fee_minimum_fpc = 5

        BLOCK_SIZE_LIMIT_FACTOR = 1 #0.5
