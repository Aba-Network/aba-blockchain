...
rm -rf ../venv || true
rm -rf venv || true
rm -rf aba_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf aba-blockchain-gui/build || true
rm -rf aba-blockchain-gui/daemon || true
rm -rf aba-blockchain-gui/node_modules || true
rm aba-blockchain-gui/temp.json || true
( cd "$PWD/aba-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
