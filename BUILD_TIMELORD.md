...
required to run a [Timelord](https://github.com/Aba-Network/aba-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Aba-Network/aba-blockchain/blob/main/install-timelord.sh)
